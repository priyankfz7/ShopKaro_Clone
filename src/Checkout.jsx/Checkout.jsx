        ...
        <>
            ...
            <Flex margin="auto" direction={["column-reverse", "column-reverse", "row"]} mt={["12", "12", "12", "12", "auto"]}>
                ...
                <Box w="35%" p="30px" position="sticky" top="180px" >
                    ...
                    <Flex justify="space-between" mb="20px" p="20px" borderTop="1px solid gainsboro" borderBottom="1px solid gainsboro">
                        ...
                        <Button bgColor="black" borderRadius="30px" color="white" fontSize="20px" w="100%" p="30px" _hover={{ bgColor: "gray.500" }} onClick={handleProceed}>
                            Go To Checkout
                        </Button>
                    </Link>
                </Box>
            ...
            <Modal isCentered isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                        <Image w="130px" m="auto" src={check} />
